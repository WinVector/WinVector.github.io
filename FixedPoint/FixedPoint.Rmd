...
Worksheet for the Win-Vector blog article [Some programming language theory in R](http://www.win-vector.com/blog/2016/01/some-programming-language-theory-in-r/).  R project (with all code) [here](http://winvector.github.io/FixedPoint/).
