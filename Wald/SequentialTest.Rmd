...
In this form (with u0=1/u1, which means s=1/2)
the acceptance rule is: "run until one of the options is more than 30 wins ahead of
the other and then quit" (the 15 coming from 2*h1=30.9).  So any acceptance rule of this form
can be justified as a special case of Wald's sequential analysis.
