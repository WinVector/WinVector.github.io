...
The above operation is a bit exotic and it (and its inverse) already go under number of different names:
  ...
  * [`moveValuesToColums*()`](https://winvector.github.io/cdata/reference/moveValuesToColumnsN.html) and [`moveValuesToRows*()`](https://winvector.github.io/cdata/reference/moveValuesToRowsN.html) (the more genaral ["fluid data"](https://github.com/WinVector/cdata/blob/master/extras/FluidData.md) operators)
