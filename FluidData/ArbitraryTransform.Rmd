 ...
 * These operators can work-in memory or at big data scale (with databases and Apache Spark; for big data we use the
 [`cdata::rowrecs_to_blocks()`](https://winvector.github.io/cdata/reference/rowrecs_to_blocks.html) and [`cdata::blocks_to_rowrecs_q()`](https://winvector.github.io/cdata/reference/blocks_to_rowrecs_q.html) variants).
...
of each other; though  `cdata::rowrecs_to_blocks()` operates on rows and [`cdata::blocks_to_rowrecs()`](https://winvector.github.io/cdata/reference/blocks_to_rowrecs.html)
