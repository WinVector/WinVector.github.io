 ...
 * The whole system is based on two primitives or operators [`cdata::moveValuesToRowsD()`](https://winvector.github.io/cdata/reference/moveValuesToRowsD.html) and [`cdata::moveValuesToColumnsD()`](https://winvector.github.io/cdata/reference/moveValuesToColumnsD.html) (for big data we use the
 ...
 * These operators can work-in memory or at big data scale (with databases and Apache Spark).
...
We can use [`cdata::moveValuesToRowsD()`](https://winvector.github.io/cdata/reference/moveValuesToRowsD.html) to do this quickly and
easily.
...
original control table by `cdata::moveValuesToRowsD()`, these two operators work roughly as inverses
of each other; though  `cdata::moveValuesToRowsD()` operates on rows and [`cdata::moveValuesToColumnsD()`](https://winvector.github.io/cdata/reference/moveValuesToColumnsD.html)
...
one can design fairly arbitrary data transform sequences (often stepping through
either a denormalized intermediate where all values are in a single row, or a 
