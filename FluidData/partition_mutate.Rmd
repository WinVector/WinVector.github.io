...
to to match the `ifelse(,,)` control structure that chooses which value to use] 
...
Note: the function `seplyr::partition_mutate_qt()` is new code and under
development in version `0.1.7` 
