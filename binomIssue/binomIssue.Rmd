...
I am going to recount "my favorite R bug."  It isn't a bug in [R](http://cran.r-project.org).  It is a bug in some code I wrote in R.  I call it my favorite bug, as it is easy to commit and (thanks to R's overly helpful nature) takes longer than it should to find.
...
Often the feedback is "just be more careful and don't write bugs."  I am careful, I write few bugs- but I find them quickly because I check a lot of my intermediate results.
